...
export default function Page() {
  ...
  async function generate() {
    ...
    try {
      ...
      const audit = seoAudit({ subject, caption: parsed.caption, network, language });
      setSeo(audit);
  ...
  /** ✅ Bouton "Optimiser SEO" : réécrit la caption et recalcule l'audit */
  function optimizeSeo() {
    ...
    const audit = seoAudit({ subject, caption: rewritten, network, language });
    setSeo(audit);
            ...
            <div className="panel__grid">
              ...
              <div className="panel__left">
                <div className="field">
                  ...
                  <textarea className="input" rows={4} value={subject} onChange={(e) => setSubject(e.target.value)} placeholder="Ex: L’importance du time management sur le milieu professionnel" />
                </div>
                ...
                <button className={["btn", "btn--primary", loading ? "btn--loading" : ""].join(" ").trim()} onClick={generate} disabled={!canGenerate || loading} style={{ width: "100%" }}>
                  {loading ? (
              ...
              <div className="panel__right" id="resultBlock">
                {!result ? (
                  <div className="empty">
                    ...
                    <div className="empty__sub">Génère pour obtenir un texte prêt à poster.</div>
                  </div>
                ) : (
                    ...
                    {seo && (
                      <div className="panel" style={{ padding: 16 }}>
                        ...
                        <div style={{ marginTop: 12, display: "flex", gap: 10, flexWrap: "wrap" }}>
                          <button className="btn btn--primary" type="button" onClick={optimizeSeo}>
                            Optimiser SEO
                          </button>
