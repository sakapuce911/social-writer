    ...
    <svg viewBox="0 0 980 720" width="100%" height="100%" role="img" aria-label="Illustration SocialWriter">
      ...
      <g filter="url(#softShadow)">
        ...
        <g transform="translate(240 410)">
          ...
          <text x="22" y="48" fontSize="18" fontWeight="950" fill="rgba(17,17,17,0.86)">Hashtags</text>
          <text x="22" y="86" fontSize="16" fontWeight="800" fill="rgba(17,17,17,0.70)">#productivité  #habitudes  #worksmart  #team</text>
          ...
          <g transform="translate(430 34)">
            ...
            <text x="55" y="31" textAnchor="middle" fontSize="16" fontWeight="950" fill="rgba(17,17,17,0.82)">copier</text>
          </g>
        </g>
      </g>
    </svg>
        ...
        <div className="container">
          <div className="hero__grid">
            <div>
              ...
              <p className="lead">
                Tu donnes le sujet, la langue et l’objectif. On te sort un post prêt à publier :
                <b> Texte</b> + <b>CTA</b> + <b>Hashtags</b>.
              </p>
